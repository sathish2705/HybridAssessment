...
import com.mindtree.uipages.RoundTripUI;
import com.mindtree.utilities.ExtentLogUtilities;
import com.relevantcodes.extentreports.ExtentTest;

public class OutStationRoundTrip extends RoundTripUI{
	WebDriver driver;
	Logger log;
	ExtentTest test;

	public OutStationRoundTrip(WebDriver driver, Logger log, ExtentTest test) throws Exception {
		this.driver = driver;
		this.test = test;
		this.log = log;
	}
